...
public final class AnnotationUtil {
     ...
     * {@link CouchRestModifierAnnotation} as annoAnnoType.
     *
     * @param clazz Class to search on.
     * @return All Annotations which are in turn annotated with {@link CouchRestModifierAnnotation}.
     */
    public static List<Annotation> getAllCouchRestModifierAnnotations(final Class clazz) {
        return getAllAnnotationsAnnotatedWith(clazz, CouchRestModifierAnnotation.class);
    }
