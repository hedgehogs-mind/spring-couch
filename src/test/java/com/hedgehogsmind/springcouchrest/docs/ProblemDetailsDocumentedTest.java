package com.hedgehogsmind.springcouchrest.docs;

import com.hedgehogsmind.springcouchrest.rest.problemdetail.I18nProblemDetailDescriptor;
import com.hedgehogsmind.springcouchrest.rest.problemdetail.problems.CouchRestProblemsTest;
...
public class ProblemDetailsDocumentedTest {
    ...
    void checkFileExists() {
        Assertions.assertNotNull(
                ...
                "The file (link) to the markdown file, which documents all the used " +
                        "ProblemDetail types in CouchRest, does not exist anymore."
        );
    }
    ...
    void checkAllProblemDetailTypesDocumented() {
        ...
        final List<I18nProblemDetailDescriptor> allProblemDescriptors = CouchRestProblemsTest.getAllProblemDescriptors();
